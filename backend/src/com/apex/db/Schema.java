...
public final class Schema {
    ...
    public static final String[] SQLITE = {
        ...
        "CREATE TABLE IF NOT EXISTS documents(id INTEGER PRIMARY KEY AUTOINCREMENT, owner_type TEXT, owner_id TEXT, kind TEXT, path TEXT, content_type TEXT, status TEXT DEFAULT 'Pending', created_at TEXT)",
    ...
    public static final String[] MYSQL = {
        "CREATE TABLE IF NOT EXISTS cars(id INT PRIMARY KEY, name TEXT, brand TEXT, category TEXT, origin TEXT, image TEXT, year INT, rate INT, hourly_rate INT, deposit INT, seats INT, engine TEXT, power TEXT, fuel TEXT, km TEXT, color TEXT, plate TEXT, car_condition TEXT, status TEXT, market_note TEXT, owner_id TEXT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS drivers(id INT PRIMARY KEY, name TEXT, phone TEXT, city TEXT, experience INT, license TEXT, active INT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS users(id VARCHAR(64) PRIMARY KEY, username TEXT, email TEXT, phone TEXT, name TEXT, cnic TEXT, role TEXT, password_hash TEXT, salt TEXT, created_at TEXT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS bookings(id VARCHAR(64) PRIMARY KEY, user_id TEXT, customer_name TEXT, email TEXT, phone TEXT, destination TEXT, pickup_mode TEXT, payment TEXT, status TEXT, payment_status TEXT, rental INT, deposit INT, home_delivery INT, total INT, paid INT, cancellation_fee INT, start_dt TEXT, end_dt TEXT, pickup_at TEXT, actual_return TEXT, extra_hours INT, extra_charges INT, final_amount INT, created_at TEXT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS booking_items(id INT PRIMARY KEY AUTO_INCREMENT, booking_id VARCHAR(64), pos INT, car_id INT, start_date TEXT, end_date TEXT, start_dt TEXT, end_dt TEXT, city TEXT, service TEXT, assigned_driver INT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS owner_applications(id VARCHAR(64) PRIMARY KEY, user_id TEXT, brand TEXT, model TEXT, status TEXT, created_at TEXT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS notifications(id VARCHAR(64) PRIMARY KEY, user_id TEXT, title TEXT, msg TEXT, time TEXT, read_flag INT, json TEXT)",
        "CREATE TABLE IF NOT EXISTS chats(user_id VARCHAR(64) PRIMARY KEY, user_name TEXT, last_time TEXT, json TEXT)",
        ...
        "CREATE TABLE IF NOT EXISTS settings(key_ VARCHAR(64) PRIMARY KEY, value TEXT)",
        "CREATE TABLE IF NOT EXISTS payments(id INT PRIMARY KEY AUTO_INCREMENT, booking_id VARCHAR(64), method TEXT, amount BIGINT, tid TEXT, receipt_doc INT, status TEXT, submitted_at TEXT, reviewed_at TEXT, note TEXT)",
        "CREATE TABLE IF NOT EXISTS documents(id INT PRIMARY KEY AUTO_INCREMENT, owner_type TEXT, owner_id TEXT, kind TEXT, path TEXT, content_type TEXT, status VARCHAR(20) DEFAULT 'Pending', created_at TEXT)",
